# JSP-Servlets-JDBC
The project aims to serve as a personal training ground for honing skills in JavaServer Pages (JSP), Servlets, and Java Database Connectivity (JDBC). It will be a simple web application that allows to practice and experiment with these technologies hands-on.
# Getting Started
